...
const promos = [
    ...
    {id: 4, img: [item2, item2], date_end: '2024-05-24T19:00:00.000Z', inactive: true, amount_left: 56, name: 'Подарочный набор', description: 'Купи ноутбук, получишь телевизор в подарок.', location: "Арамболь, Гиркарвада", acts: {views: 145, scs: 45, wish: 63}, brand_id: 2, brand_name: "МТС", brand_img: brandMts, brand_contacts: {phone: "79995553333", telegram: "https://tg.me/paymeg", whatsapp: "+79995553333", facebook: "facebook.com", website: "google.com"}, brand_role: 'Магазин электроники', adresses: adresses, delivery: deliveries},
