...
const promos = [
    {id: 6, img: [item3, item3, item3, item3, item3, item3, item3, item3, item3, item3], date_end: '2024-04-24T19:00:00.000Z', amount_left: 134, name: 'Apple Watch', description: 'Купи iPhone и получишь <b>Apple Watch в подарок</b>.', location: "Москва, м. Спортивная", acts: {views: 145, scs: 45, wish: 63}, brand_id: 3, brand_name: "Apple", brand_img: brandApple, brand_contacts: {phone: "79995553333", telegram: "https://tg.me/paymeg", whatsapp: "+79995553333", facebook: "facebook.com", website: "google.com", tg: 'https://t.me/pl_bot'}, brand_role: 'Магазин электроники', adresses: [], delivery: deliveries},
    {id: 1, img: [item1, item1], date_end: '2024-04-22T19:00:00.000Z', amount_left: 134, name: 'Телевизор в подарок, второй в подарок', description: '<b>Купи ноутбук</b>, получишь телевизор в подарок. Купи ноутбук, получишь телевизор в подарок. Купи ноутбук, получишь телевизор в подарок. Купи ноутбук, получишь телевизор в подарок.', location: "Москва, м. Спортивная", acts: {views: 145, scs: 45, wish: 63}, brand_id: 1, brand_name: "Ситилинк", brand_img: brandMegafon, brand_contacts: {phone: "79995553333", telegram: "https://tg.me/paymeg", whatsapp: "+79995553333", facebook: "facebook.com", website: "google.com", tg: 'https://t.me/pl_bot'}, brand_role: 'Магазин электроники', adresses: adresses, delivery: {list: [], description: ''}},
    ...
    {id: 3, img: [item1, item1], date_end: '2024-04-27T19:00:00.000Z', amount_left: 134, name: 'Телевизор в подарок, второй в подарок', description: '<b>Купи ноутбук, получишь телевизор в подарок. Купи ноутбук, получишь телевизор в подарок. Купи ноутбук, получишь телевизор в подарок. Купи ноутбук, получишь телевизор в подарок.</b>', location: "Москва, м. Спортивная", acts: {views: 145, scs: 45, wish: 63}, brand_id: 1, brand_name: "Ситилинк", brand_img: brandMegafon, brand_contacts: {phone: "79995553333", telegram: "https://tg.me/paymeg", whatsapp: "+79995553333", facebook: "facebook.com", website: "google.com", tg: 'https://t.me/pl_bot'}, brand_role: 'Магазин электроники', adresses: adresses, delivery: deliveries},
...
export const promosSlice = createSlice({
    ...
    reducers: {
        ...
        setMyGiftsData: (state, action) => {
            return {
                ...state,
                my_gifts: [...promos.slice(0, 2), ...pausedPromo, ...promos.slice(3)]
            }
        },
        setWishlistData: (state, action) => {
            return {
                ...state,
                wishlist: [...promos.slice(0, 2), ...pausedPromo, ...promos.slice(3)]
            }
        },
